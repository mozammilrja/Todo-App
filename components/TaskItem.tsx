    ...
    <Draggable draggableId={taskId} index={index}>
      {(provided, snapshot) => (
        <div
          ...
          className={`bg-white rounded-2xl p-4 shadow-sm border border-gray-100 transition-all duration-200 group w-full ${
            snapshot.isDragging
            ...
            <div className="flex items-center gap-2 flex-wrap sm:flex-nowrap">
              ...
              {isEditing ? (
                ...
                <>
                  <button
                    onClick={handleEdit}
                    className="opacity-0 group-hover:opacity-100 text-gray-300 hover:text-blue-500 transition"
                    title="Edit">
                  ...
                  <button
                    ...
                    title={isMainFocus ? "Unpin" : "Pin"}>
                    <Star
                      className={`w-4 h-4 ${isMainFocus ? "fill-current" : ""}`}
                    />
                  </button>
                  ...
                  <button
                    ...
                    title={task.completed ? "Uncheck" : "Complete"}>
                    {task.completed ? (
